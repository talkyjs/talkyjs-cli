...
@talkyjs/cli/1.0.0 darwin-x64 node-v12.9.1
$ talky --help [COMMAND]
USAGE
  $ talky COMMAND
...
...
_See code: [src/commands/generate.ts](https://github.com/ask-utils/talkyjs-cli/blob/v1.0.0/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/ask-utils/talkyjs-cli/blob/v1.0.0/src/commands/init.ts)_
...
_See code: [src/commands/new.ts](https://github.com/ask-utils/talkyjs-cli/blob/v1.0.0/src/commands/new.ts)_
<!-- commandsstop -->
